...
export function EmployeeApp({ onLogout }: EmployeeAppProps) {
  ...
  const [activeView, setActiveView] = useState<'home' | 'notifications' | 'history' | 'team'>('home');
              ...
              <div className="space-y-4">
                ...
                <Card>
                  ...
                  <CardContent className="p-0">
                    <div className="bg-gradient-to-br from-blue-100 to-blue-50 h-64 flex items-center justify-center rounded-b-lg relative">
                      <div className="text-center p-4 bg-white/90 rounded-lg shadow-lg">
                        ...
                        <p className="text-sm text-slate-600 mt-1">Seguimiento tipo Uber/DiDi</p>
                      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg">
        <div className="max-w-lg mx-auto grid grid-cols-4 gap-1 p-2">
          <Button
            ...
            className={`flex-col h-16 ${activeView === 'home' ? 'bg-blue-600' : ''}`}
          ...
          <Button
            ...
            className={`flex-col h-16 relative ${activeView === 'notifications' ? 'bg-blue-600' : ''}`}
          ...
          <Button
            ...
            className={`flex-col h-16 ${activeView === 'history' ? 'bg-blue-600' : ''}`}
          ...
          <Button
            ...
            className={`flex-col h-16 ${activeView === 'team' ? 'bg-blue-600' : ''}`}
