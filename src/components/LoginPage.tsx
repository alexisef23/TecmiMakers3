...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-emerald-700 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-white mb-2">OXXO GO</h1>
          <p className="text-blue-100">Sistema de Gestión de Transporte Corporativo</p>
        </div>
